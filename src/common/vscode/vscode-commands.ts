...
export enum Command {
  ...
  ToggleExcludesShowAll = 'toggleExcludesShowAll',
  ToggleExcludesShowAllActive = 'toggleExcludesShowAllActive',
  ToggleExcludesGroupMode = 'toggleExcludesGroupMode',
  ToggleExcludesGroupModeGrouped = 'toggleExcludesGroupModeGrouped',
  AddVscodeExclude = 'addVscodeExclude',
  ToggleVscodeExclude = 'toggleVscodeExclude',
  ToggleVscodeExcludesShowAll = 'toggleVscodeExcludesShowAll',
  ToggleVscodeExcludesShowAllActive = 'toggleVscodeExcludesShowAllActive',
  ToggleVscodeExcludesGroupMode = 'toggleVscodeExcludesGroupMode',
  ToggleVscodeExcludesGroupModeGrouped = 'toggleVscodeExcludesGroupModeGrouped',
  OpenVscodeExcludesSettings = 'openVscodeExcludesSettings',
  ShowLogs = 'showLogs',
  ShowWorkspaceState = 'showWorkspaceState',
  ClearWorkspaceState = 'clearWorkspaceState',
  SelectWorkspace = 'selectWorkspace',
  ChangeTasksLocation = 'changeTasksLocation',
  ShowGlobalActions = 'showGlobalActions',
  ConfigureGlobalActions = 'configureGlobalActions',
  RemoveGlobalActionsConfig = 'removeGlobalActionsConfig',
